...
**Vertical exaggeration** scales terrain height live. Typed values are not capped at the slider's maximum; empty or invalid input reverts to the last valid value.
